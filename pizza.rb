...
def make_pizza()
    print "How many pizzas would you like? : "; pizza_count = $stdin.gets.chomp.to_i
    while pizza_count > 0
    ...
    if (delivery == "y") || (delivery == "yes")
        print "How many miles away do you need your pizza delivered? : "; miles = $stdin.gets.chomp.to_i
        if miles >= 35; price += 10 + (0.20 * miles)
        end
    elsif miles < 35; price += 10
